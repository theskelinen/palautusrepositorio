...
class TestKauppa(unittest.TestCase):
    ...
    def test_maksettaessa_kahden_eri_tuotteen_ostos_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
    ...
    def test_maksettaessa_kahden_saman_tuotteen_ostos_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
    ...
    def test_maksettaessa_tuote_jota_on_varastossa_ja_tuote_jota_ei_ole_varastossa_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
    ...
    def test_poista_korista_palauttaa_oikean_tuotteen_varastoon(self):
        ...
        # varmistetaan, että tuotteen palautus varastoon on kutsuttu oikealla tuotteella
        tuote = Tuote(1, "maito", 5)
        self.varasto_mock.palauta_varastoon.assert_called_with(tuote)

    def test_poista_korista_paivittaa_ostoskoria_oikein(self):
